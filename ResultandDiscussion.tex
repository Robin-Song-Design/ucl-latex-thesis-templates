...
\begin{table}[ht]
    \caption{Table of TET (second) for Layout A,B,C,A2,B2,C2} % title of Table
    \centering % used for centering table
    \label{tab:tettable}
    \begin{tabular}{c c c c c c c} % centered columns (7 columns)
        \hline % inserts single horizontal line
        Width(m) &  A  & B     & C     & A2    & B2    & C2  \\ [0.5ex] % headers
        \hline % inserts single horizontal line
...
\begin{table}[ht]
    \caption{Table of TET vs Bottleneck Width} % title of Table
    \centering % used for centering table
    \label{tab:tettable_bottleneck}
    \begin{tabular}{c c} % centered columns (2 columns)
        \hline % inserts single horizontal line
        Width(m) & TET \\ [0.5ex] % headers
        \hline % inserts single horizontal line
        1.0  & 84.86 \\ [1ex]
        1.2  & 74.86 \\ [1ex]
        1.4  & 72.92 \\ [1ex]
