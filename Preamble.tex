...
This study systematically investigates how internal spatial configurations in office spaces — specifically desk layout, corridor width, number of exits, and door width — influence the efficiency of orderly evacuation under fixed building constraints. We conduct multi-scale agent-based simulations within a coupled Rhino 9 and JuPedSim workflow, constructing two prototypes (Small and Big) and comparing different internal layouts (A, B, C), various corridor and door width combinations, and single vs. double exits configuration. Trajectory data are used to derive metrics such as speed, path length, Total Evacuation Time (TET), and congestion hotspots. Results indicate that internal layout significantly affects congestion hotspots and path choices, with door-corridor width coupling showing threshold effects and scale dependence, especially in the Big prototype. Spatial patterns are analyzed via speed and trajectory diagrams; robustness is evaluated via standard deviation from repeated simulation runs. The results can help architects and engineers to find the key elements for optimizing office layouts for safety and efficiency.
